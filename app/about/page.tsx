export default function AboutPage() {
    return (
      <section className="space-y-4">
        ...
        <p>While I was a molecular marine biologist, I had to write bash scripts, python scripts, and wrangle data in R in order to analyze massive amounts of DNA data that I stored in SQL relational databases.  Through this, I discovered a love of coding and found excuses to code up and automate as much of my life as possible.</p>
